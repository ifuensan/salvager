...
The recommended image tag for new deployments is `ghcr.io/ifuensan/salvager:0.4.2` (pinned). `:latest` follows the newest release; pin to `:0.4.2` for reproducible deploys during the v1.0 burn-in window.
